...
const getTakerFee = (inputMint, outputMint, fee) => {
    const isUsdStable = USD_STABLE_PAIR.includes(inputMint.toString()) &&
        USD_STABLE_PAIR.includes(outputMint.toString());
    const isSolStable = SOL_STABLE_PAIR.includes(inputMint.toString()) &&
...
exports.getTakerFee = getTakerFee;
